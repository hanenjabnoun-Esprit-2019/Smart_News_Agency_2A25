...
public:
    ...
    void setupUi(QDialog *Marketing)
    {
        ...
        stackedWidget_2->setGeometry(QRect(9, 10, 771, 341));
...
""));
        ...
        tabWidget_3->setGeometry(QRect(-10, 0, 771, 291));
...
""));
        ...
        search = new QPushButton(Consulter_2);
        search->setObjectName(QStringLiteral("search"));
        search->setGeometry(QRect(380, 30, 75, 23));
        recherche = new QLineEdit(Consulter_2);
        recherche->setObjectName(QStringLiteral("recherche"));
        recherche->setGeometry(QRect(260, 30, 113, 20));
        comboBox = new QComboBox(Consulter_2);
        comboBox->setObjectName(QStringLiteral("comboBox"));
        comboBox->setGeometry(QRect(130, 30, 69, 22));
...
""));
        ...
        tableView->setGeometry(QRect(60, 60, 441, 191));
...
"font: 75 12pt \"Adobe Gothic Std B\";"));
    ...
    void retranslateUi(QDialog *Marketing)
    {
        ...
        search->setText(QApplication::translate("Marketing", "Rechercher", Q_NULLPTR));
