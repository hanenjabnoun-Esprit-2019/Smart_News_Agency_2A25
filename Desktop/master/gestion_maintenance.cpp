#include "gestion_maintenance.h"
#include "ui_gestion_maintenance.h"
...
gestion_maintenance::gestion_maintenance(QWidget *parent) :
    QDialog(parent),
    ui(new Ui::gestion_maintenance)
{
Equipement E;
    ui->setupUi(this);
...
void gestion_maintenance::on_pb_ajouter_clicked()
{
...
void gestion_maintenance::on_pb_supprimer_clicked()
{
    /*
    Equipement E;
...
void gestion_maintenance::on_pushButton_maintenance_clicked()
{
     ui->stackedWidget->setCurrentIndex(1);      //SCROLL
}

void gestion_maintenance::on_pushButton_equipement_clicked()
{
    ui->stackedWidget->setCurrentIndex(0);      //SCROLL
}

void gestion_maintenance::on_pushButton_updateequip_clicked()
{
/*
...
void gestion_maintenance::on_pb_ajouterm_clicked()
{
    /*
...
void gestion_maintenance::on_pb_supprimerm_clicked()
{
...
void gestion_maintenance::on_pb_updatem_clicked()
{
...
void gestion_maintenance::on_pb_trier_clicked()
{
    Equipement E;
...
void gestion_maintenance::on_pushButton_7_clicked()
{
   /* QString strStream;
...
void gestion_maintenance::on_rechercheav_cursorPositionChanged(int arg1, int arg2)
{
   /* Maintenance1 M;
...
void gestion_maintenance::on_filtrer_clicked()
{
    Equipement E;
