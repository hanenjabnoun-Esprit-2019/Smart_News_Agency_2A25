...
bool Maintenance1::ajouter_maintenance()
{
   ...
   QString idequip_string= QString::number(idequip);
    query.prepare("INSERT INTO MAINTENANCE (ID_MAINTENANCE, ID_EMPLOYE, ID_EQUIPEMENT, TYPE_MAINTENANCE, DATE_MAIN) "
...

{
    QSqlQueryModel* model=new QSqlQueryModel();
       ...
       model->setHeaderData(2, Qt::Horizontal, QObject::tr("ID_EQUIPEMENT"));
...
bool Maintenance1::supprimer_maintenance(int idm)
{
        ...
        query.prepare("Delete from MAINTENANCE where ID_MAINTENANCE=:idm");
...
bool Maintenance1::modifier_maintenance()
{
    ...
    query.prepare("UPDATE MAINTENANCE SET  ID_EMPLOYE=:idemp, ID_EQUIPEMENT=:idequip, TYPE_MAINTENANCE=:typep, DATE_MAIN=:datem WHERE ID_MAINTENANCE=:idm");
